...
export default function CycleTyresAdjustment() {
  ...
  async function fetchItems() {
    const data = await apiGet('/cycletyres/adjustment/');
    if (data) {
      setItems(data.items || []);
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await apiPost('/cycletyres/adjustment/', payload);
    setLoading(false);
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <input
                ...
                placeholder="e.g. Reconciliation, physical count correction"
              />
            </div>
